...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "acexxy"         # 用户名
UUID = "668f6600-1326-4b28-9dc2-93439d704ac1"                     # UUID，留空则自动生成
PORT = 49999                  # Vmess端口，留空或0则自动生成
DOMAIN = "streamlit.zbo.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiODljNzZjOWMwZGMyODgxYzRkNmNlY2NlYzA3ODBiNTMiLCJ0IjoiYjAzOThiMzctNjhkYy00ZjQ2LWJiNDAtOWM5ZmI0M2E0ZmFhIiwicyI6Ik5HVTVaR0poWkdNdE9EVmpOeTAwWmpFMkxXRTJZMlF0TVRJM01UQXhZemt3TjJRNSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
